...
ACCESS_LOG_TEXT_FILE="/Users/vang4999/data-eng/phdata/apache-access-log.txt"

KAFKA_BOOTSTRAP_SERVERS="localhost:9092"

ACCESS_LOG_TOPIC="access-log"

CHECKPOINT="/Users/vang4999/data-eng/phdata/checkpoint-access-log/"

cd ../ \
&& sbt assembly \
&& $SPARK_HOME/bin/spark-submit \
--packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.3.0 \
--class me.xiongvang.ddos.LoadAccessLog \
--master local \
